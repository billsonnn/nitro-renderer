...
export class NitroMessages implements IMessageConfiguration
{
    ...
    private registerEvents(): void
    {
        ...
        this._events.set(IncomingHeader.ROOM_GET_FILTER_WORDS, RoomGetFilterWordsMessageEvent);
    ...
    private registerComposers(): void
    {
        ...
        this._composers.set(OutgoingHeader.ROOM_FILTER_WORDS, RoomFilterWordsMessageComposer);
        this._composers.set(OutgoingHeader.ROOM_FILTER_WORDS_MODIFY, RoomFilterWordsModifyMessageComposer);
