...
export class NitroMessages implements IMessageConfiguration
{
    ...
    private registerEvents(): void
    {
        ...
        this._events.set(IncomingHeader.PERK_CITIZENSHIP_VIP_OFFER_PROMO_ENABLED, CitizenshipVipOfferPromoEnabledEvent);
