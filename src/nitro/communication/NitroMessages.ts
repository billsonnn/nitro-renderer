...
export class NitroMessages implements IMessageConfiguration
{
    ...
    private registerEvents(): void
    {
        ...
        // SNOWSTORM
        this._events.set(IncomingHeader.SNOWSTORM_ON_STAGE_ENDING, SnowStormOnStageEndingEvent);
    }
    ...
    private registerComposers(): void
    {
        ...
        // SNOWSTORM
        this._events.set(OutgoingHeader.SNOWSTORM_ON_STAGE_ENDING, SnowStormOnStageEndingComposer);
    }
