...
export class NitroMessages implements IMessageConfiguration
{
    ...
    private registerComposers(): void
    {
        ...
        this._composers.set(OutgoingHeader.GETWEEKLYCOMPETITIVELEADERBOARD, GetWeeklyCompetitiveLeaderboardComposer);
        this._composers.set(OutgoingHeader.GETFRIENDSWEEKLYCOMPETITIVELEADERBOARD, GetFriendsWeeklyCompetitiveLeaderboardComposer);
        this._composers.set(OutgoingHeader.GETWEEKLYGAMEREWARDWINNERS, GetWeeklyGameRewardWinnersComposer);
        this._composers.set(OutgoingHeader.GAME2GETFRIENDSLEADERBOARD, Game2GetFriendsLeaderboardComposer);
        this._composers.set(OutgoingHeader.GAME2GETTOTALLEADERBOARD, Game2GetTotalLeaderboardComposer);
